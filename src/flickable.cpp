...
Flickable::Flickable(QObject *parent): QObject(parent),
...
void Flickable::activateOn(QWidget *widget)
{
...
void Flickable::deactivateFrom(QWidget *widget)
{
    QAbstractScrollArea *scrollArea = dynamic_cast<QAbstractScrollArea*>(widget);
    if (scrollArea) {
        QWidget *viewport = scrollArea->viewport();
...
bool Flickable::eventFilter(QObject *object, QEvent *event)
{
...
void Flickable::timerEvent(QTimerEvent *event)
{
    int count = 0;
