...
IF(NOT QT_MOBILITY_FOUND)
    if(QT_MOBILITY_TOO_OLD)
	    MESSAGE(WARNING "The installed QtMobility version ${QT_MOBILITY_VERSION} it too old, version ${QtMobility_FIND_VERSION} is required.")
    ELSEIF(QT_MOBILITY_TOO_NEW)
	    MESSAGE(WARNING "The installed QtMobility version ${QT_MOBILITY_VERSION} it too new, version ${QtMobility_FIND_VERSION} is required.")
    ELSE()
	    MESSAGE(WARNING "QtMobility not found.")
    ENDIF()
ELSE()
    ...
    message("-- Found QtMobility version " ${QT_MOBILITY_VERSION})
ENDIF()
